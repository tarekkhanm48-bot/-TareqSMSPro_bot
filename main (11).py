        ...
        "reply_markup": {
            "inline_keyboard": [
                [{"text": "📱 Get Number",      "callback_data": "btn_get_number"},
                 {"text": "🌐 Available Country","callback_data": "btn_countries"}],
                [{"text": "📊 Active Number",   "callback_data": "btn_active"},
                 {"text": "🔍 Search Number",   "callback_data": "btn_search"}],
                [{"text": "💬 Support",          "callback_data": "btn_support"},
                 {"text": "👥 Refer",            "callback_data": "btn_refer"}],
                [{"text": "👤 My Status",        "callback_data": "btn_status"}],
            ]
        }
    }, timeout=10)
